public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Первая книга: " + "\"" + catsCradle.getTitle() + "\"" + ", написанна в " + catsCradle.getYearOfPublication() + " году. Автор: " + kurtVonnegut.getFirstName() + " " + kurtVonnegut.getSecondName());
